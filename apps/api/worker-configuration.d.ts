/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=apps/api/wrangler.jsonc apps/api/worker-configuration.d.ts` (hash: 8df3bdba1eb03aa1c7f9dcf9a51edce1)
