...
import { ExecutiveHeader, MetricGrid, Panel, ProgressBar, SceneBanner, NpcPortrait, RivalPortrait } from '../components/ui';
    ...
    <>
      ...
      {news.length > 0 ? (
        <Panel eyebrow="電化時報" title="業界ニュース・時代速報">
          <div style={{ display: 'flex', gap: 12, alignItems: 'center', marginBottom: 10, background: '#f5f1e5', padding: '8px 12px', borderLeft: '4px solid #b8860b' }}>
            <NpcPortrait npcId="journalist" size={44} />
            <p style={{ margin: 0, fontSize: '.84rem', color: '#4a5148' }}>
