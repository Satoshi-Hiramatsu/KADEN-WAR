...
describe('ゲーム内暦の基盤PoC', () => {
  it.each([
    [0, { year: 1960, month: 1, week: 1 }],
    [3, { year: 1960, month: 1, week: 4 }],
    [4, { year: 1960, month: 2, week: 1 }],
    [47, { year: 1960, month: 12, week: 4 }],
    [48, { year: 1961, month: 1, week: 1 }],
    [2447, { year: 2010, month: 12, week: 4 }],
